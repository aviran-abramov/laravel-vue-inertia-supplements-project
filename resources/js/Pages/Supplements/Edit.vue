...
const form = useForm<ISupplement>({
    ...
    additional_info_1: supplement.additional_info_1,
    additional_info_2: supplement.additional_info_2
});
</script>

<template>
    <Head title="Edit Supplement" />

    <AppLayout title="Edit Supplement">
        <form @submit.prevent="form.patch(route('supplements.patch', supplement.id))" class="space-y-4 border border-black rounded w-[400px] mx-auto py-4 flex flex-col items-center">
            <!-- Name -->
            <div>
            ...
            <FormSubmitButton :processing="form.processing" variant="update">Update</FormSubmitButton>
        </form>
    </AppLayout>
</template>
